...
<script src="/clothes/buy/buyList.js"></script>
  		...
  		<c:forEach var="i" begin="0" end="${buyLists.size()-1}">
    		...
    		<table> 
     			...
     			<tr>
       				...
       				<td width="300"> <img src="/clothes/clothesImage/${buylist.getClothes_image()}" class="cartimage">${buylist.getClothes_title()}</td> 
       				<td width="100">
