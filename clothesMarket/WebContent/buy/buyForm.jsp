...
<script src="/clothes/buy/buyForm.js"></script>
	...
	<table>
		...
		<c:set var="total" value="0"/>
  		<c:forEach var="cart" items="${cartLists}">
  			<tr> 
       			<td width="300">
       				<img src="/clothes/clothesImage/${cart.getClothes_image()}" class="cartimage">${cart.getClothes_title()}
       			</td> 
       			...
       			<td width="50" class="cen">${cart.getClothes_size() }</td>
       			<td width="100" class="cen">
...
<div id="buyArea">
	<form name="buyForm" method="post" action="/clothes/buyPro.do">
		<table>
   			<tr> 
