...
public class LogonDAO {
  ...
  //회원 가입 처리에서 사용하는 메소드
    public void insertMember(LogonVO member){
  ...
  //로그인 폼 처리의 사용자 인증 처리에서 사용하는 메소드
	...
	public LogonVO getMember(String id){
	    Connection conn = null;
	    PreparedStatement pstmt = null;
	    ResultSet rs = null;
	    LogonVO member=null;
	    ...
	    try {
	       ...
	       if (rs.next()) {//해당 아이디에 대한 레코드가 존재
	            	member = new LogonVO();//데이터저장빈 객체생성
    ...
    public LogonVO getMember(String id, String passwd){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        LogonVO member=null;
	...
	public int updateMember(LogonVO member){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs= null;
        int x=-1;
